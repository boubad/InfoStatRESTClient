...
/**
 * Jersey REST client generated for REST resource:SemestreResource
 * [semestre]<br>
 * USAGE:
 * <pre>
 *        SemestreJerseyClient client = new SemestreJerseyClient();
 ...
 * @author boubad
 */
public class SemestreJerseyClient {

    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8888/InfoStat-war/webresources";

    public SemestreJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        config.getClasses().add(SemestreDTO.class);
        config.getClasses().add(SemestreDTO[].class);
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("semestre");
    }

    public SemestreJerseyClient(String baseURI) {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        config.getClasses().add(SemestreDTO.class);
        config.getClasses().add(SemestreDTO[].class);
        client = Client.create(config);
        webResource = client.resource(baseURI).path("semestre");
    }
    ...
    public <T> T findByAnnee_XML(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("annee/{0}", new Object[]{id}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findByAnnee_JSON(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("annee/{0}", new Object[]{id}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }

    public <T> T findByDepartement_XML(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("departement/{0}", new Object[]{id}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findByDepartement_JSON(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("departement/{0}", new Object[]{id}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
    ...
    public <T> T findByAnneeSigle_XML(Class<T> responseType, String id, String sigle) throws UniformInterfaceException {
        WebResource resource = webResource;
        if (id != null) {
    ...
    public <T> T findByAnneeSigle_JSON(Class<T> responseType, String id, String sigle) throws UniformInterfaceException {
        WebResource resource = webResource;
        if (id != null) {
            resource = resource.queryParam("id", id);
        }
