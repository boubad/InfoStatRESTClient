 ...
 * USAGE:
 * <pre>
 *        EtudiantEventJerseyClient client = new EtudiantEventJerseyClient();
...
public class EtudiantEventJerseyClient {
    ...
    public EtudiantEventJerseyClient(String baseURI) {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        config.getClasses().add(EtudiantEventDTO.class);
        config.getClasses().add(EtudiantEventDTO[].class);
        client = Client.create(config);
    ...
    public <T> T findData_XML(Class<T> responseType, String genre, String evtid,
        ...
        if (evtid != null) {
            resource = resource.queryParam("evtid", evtid);
        }
        if (etudiantid != null) {
    ...
    public <T> T findData_JSON(Class<T> responseType, String genre, String evtid, String etudiantid, String semestreid) throws UniformInterfaceException {
        WebResource resource = webResource;
        if (genre != null) {
            resource = resource.queryParam("genre", genre);
        }
